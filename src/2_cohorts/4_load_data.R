...
load_data <- function(cohort){
  ...
  cancer_list <- c("has_cancer", "group_solid", "group_hematological", "group_metastasized",
                    ...
                    "loc_melanoma", "loc_breast", "loc_female_genital", "loc_male_genital", 
                    "loc_renal_urinary", "loc_endocrine", "loc_lymphomas", "loc_leukemia",
                    "loc_other_hematological", "loc_others",
